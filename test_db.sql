...
-- ************************************** `cats`
 ...
 -- IN ORDER TO MAKE CATEGORY_ID A REFERENCE IT MUST BE CREATED ON NEW CATEGORY CREATION AND NOT ASSIGNED BY USER
 -- MAYBE IN FUTURE ADMINISTRATOR CAN CREATE AND LIMIT CATEGORIES
